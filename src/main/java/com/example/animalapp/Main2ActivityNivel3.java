...
public class Main2ActivityNivel3 extends AppCompatActivity {
    ...
    public void NumAleatorio() {
        ...
        if (score <= 29) { // SIEMPRE QUE EL SCORE SEA MENOR O IGUAL QUE NUEVE SIGUE HACIENDO LAS OPERACIONES BASICAS
            ...
            Intent intent = new Intent(this, Main2ActivityNivel4.class);
