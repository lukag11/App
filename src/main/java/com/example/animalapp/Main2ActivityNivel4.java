...
public class Main2ActivityNivel4 extends AppCompatActivity {
    ...
    public void NumAleatorio() {
        ...
        if (score <= 39) { // SIEMPRE QUE EL SCORE SEA MENOR O IGUAL QUE NUEVE SIGUE HACIENDO LAS OPERACIONES BASICAS
            ...
            Intent intent = new Intent(this, Main2ActivityNivel5.class);
