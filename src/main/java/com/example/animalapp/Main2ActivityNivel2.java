...
public class Main2ActivityNivel2 extends AppCompatActivity {
    ...
    public void NumAleatorio() {
        ...
        if (score <= 19) { // SIEMPRE QUE EL SCORE SEA MENOR O IGUAL QUE NUEVE SIGUE HACIENDO LAS OPERACIONES BASICAS
            ...
            Intent intent = new Intent(this, Main2ActivityNivel3.class);
