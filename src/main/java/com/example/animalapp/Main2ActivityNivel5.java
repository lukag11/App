...
public class Main2ActivityNivel5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 5 - Multiplicacion Basicas", Toast.LENGTH_SHORT).show();
    ...
    public void NumAleatorio() {
        ...
        if (score <= 49) { // SIEMPRE QUE EL SCORE SEA MENOR O IGUAL QUE NUEVE SIGUE HACIENDO LAS OPERACIONES BASICAS
            ...
            Intent intent = new Intent(this, Main2ActivityNivel6.class);
